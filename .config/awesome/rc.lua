...
globalkeys = gears.table.join(
    ...
    --Rofi 
    awful.key({ modkey },            "d",     function () awful.util.spawn("rofi -show drun -show-icons -fake-transparency") end,
              {description = "run rofi", group = "launcher"}),

    --Rofi as Window Switcher 
    awful.key({ modkey },            "Tab",     function () awful.util.spawn("rofi -show drun -show-window -fake-transparency") end,
...
--Autostart
	--Set Compositor
	awful.spawn.with_shell("picom --config /home/carlos/.config/picom/picom.conf")
	--Start Compositor
	awful.spawn.with_shell("feh --bg-fill --randomize /home/carlos/Imágenes/Wallpapers/")
	--Set NetworManager Applet
	awful.spawn.with_shell("nm-applet")
	--Set Pulse Audio Applet
